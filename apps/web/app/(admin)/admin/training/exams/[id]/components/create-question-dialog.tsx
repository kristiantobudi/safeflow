...
import { type QuestionFormValues, questionSchema } from './question-schema';

export default function CreateQuestionDialog({ examId }: { examId: string }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="shadow-lg shadow-primary/20 px-6 font-bold h-10">
